...
const Navbar = () => {
  ...
  return (
    <div className="w-full shadow-s">
      <header className="fixed top-0 flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-white text-sm py-4 dark:bg-neutral-800 ">
        <nav
